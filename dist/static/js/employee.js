...
function toggleDropdown() {
  const dropdown = document.querySelector('.emp-dropdown');
...
function showRightColumnContent(item) {
  let rightContent = document.getElementById('emp-right-content');
  
  if (item === 'Department') {
      rightContent.innerHTML = '<p onclick="selectRightContent(\'Radiology\')">Radiology</p><p onclick="selectRightContent(\'Cardiology\')">Cardiology</p>';
  } else if (item === 'Status') {
      rightContent.innerHTML = '<p onclick="selectRightContent(\'Full-time\')">Full-time</p><p onclick="selectRightContent(\'Part-time\')">Part-time</p>';
    } else if (item === 'Employment Type') {
      rightContent.innerHTML = '<p onclick="selectRightContent(\'Active\')">Active</p><p onclick="selectRightContent(\'Resigned\')">Resigned</p>';
  } else if (item === 'Position') {
      rightContent.innerHTML = '<p onclick="selectRightContent(\'Nurse\')">Nurse</p><p onclick="selectRightContent(\'Physician\')">Physician</p>';
  }
}

// Change the placeholder to the selected right column content
function selectRightContent(content) {
    let placeholderText = document.querySelector('#emp-dropdown-placeholder span:first-child');
    placeholderText.textContent = content;

    // Close the dropdown after selection
    document.querySelector('.emp-dropdown').classList.remove('active');
}
...
function openDeleteModal() {
  ...
  message.textContent = 'Are you sure you want to delete this employee? This action cannot be undone.';
  modal.style.display = 'block';
...
function confirmDelete() {
  // Handle the delete logic here, such as sending a request to delete the employee
