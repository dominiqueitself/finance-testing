...
function toggleDropdown() {
  ...
  function showRightColumnContent(item) {
    let rightContent = document.getElementById('hospital-right-content');
  ...
  function selectRightContent(content) {
      let placeholderText = document.querySelector('#hospital-dropdown-placeholder span:first-child');
      placeholderText.textContent = content;
  
      // Close the dropdown after selection
      document.querySelector('.hospital-dropdown').classList.remove('active');
  }
